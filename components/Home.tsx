  ...
  return (
    <div className="animate-in fade-in duration-700 bg-white dark:bg-slate-950">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 pt-24 pb-32">
          <div className="max-w-5xl text-white">
            <div className="flex items-center space-x-4 space-x-reverse mb-10 animate-in slide-in-from-bottom duration-500">
              <span className="px-5 py-2 bg-emerald-600 text-[10px] md:text-xs font-black uppercase tracking-[0.3em] rounded-full shadow-2xl shadow-emerald-500/40">
                {t.home.heroTag}
              </span>
            ...
            <h1 className="text-6xl md:text-9xl font-black leading-[0.9] mb-12 animate-in slide-in-from-bottom duration-700 tracking-tighter italic drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
              ...
              <br />
              <span className="text-emerald-400 not-italic block mt-4 uppercase tracking-tighter">{t.home.heroTitle.split('،')[1] || t.home.heroTitle.split(',')[1]}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8 sm:space-x-reverse animate-in slide-in-from-bottom duration-1000 delay-200">
              <Link to="/missions" className="px-12 py-6 bg-white text-[#002147] hover:bg-emerald-500 hover:text-white rounded-[2rem] font-black text-lg flex items-center justify-center transition-all group shadow-2xl hover:scale-105 active:scale-95">
        ...
        {/* Global Space Dashboard Stats - NASA Layout */}
             ...
             <div className="flex items-center space-x-12 space-x-reverse p-6 glass-morphism rounded-[3rem] shadow-2xl">
                {[
                  ...
                  <div key={i} className="flex items-center space-x-5 space-x-reverse px-6 border-r last:border-0 border-white/10">
                    <div className="w-14 h-14 rounded-2xl bg-emerald-500/20 flex items-center justify-center text-emerald-400 group">
      ...
      {/* Advanced Satellite Tracking Section */}
           ...
           <div className="flex flex-col lg:flex-row items-center justify-between mb-20 gap-12">
              <div className="max-w-xl">
                 <div className="flex items-center space-x-3 space-x-reverse mb-6">
                    ...
                    <h2 className="text-xs font-black uppercase tracking-[0.4em] text-emerald-600">{t.home.trackerTitle}</h2>
                 </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Link to="/launch-dashboard" className="px-10 py-5 bg-[#002147] text-white rounded-3xl font-black shadow-2xl hover:bg-emerald-600 transition-all flex items-center justify-center">
      ...
      {/* Highlights - New Interactive Exploration Section */}
         ...
         <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
               <div className="relative group overflow-hidden rounded-[3rem] shadow-2xl aspect-square lg:aspect-video">
                  ...
                  <div className="absolute bottom-10 left-10 right-10">
                     <div className="flex items-center space-x-3 space-x-reverse mb-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-emerald-400">Live Mission Feed</span>
                     </div>
               ...
               <div className="space-y-12">
                  <h2 className="text-xs font-black text-emerald-600 uppercase tracking-[0.4em]">Agency Focus</h2>
      ...
      {/* Explore Grid - NASA Official Card Design */}
      <section className="py-24 md:py-40 bg-gray-50 dark:bg-slate-900/40 relative">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-xs font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-[0.5em] mb-6">Discovery Hub</h2>
             ...
             {stories.map((story, i) => (
               <div key={i} className="group flex flex-col bg-white dark:bg-slate-900 rounded-[3rem] overflow-hidden border border-gray-100 dark:border-white/5 shadow-xl hover:shadow-[0_40px_80px_rgba(0,0,0,0.1)] transition-all duration-700">
                  <div className="relative h-80 overflow-hidden">
                    ...
                    <div className="absolute top-8 left-8 px-5 py-2 bg-emerald-600/90 backdrop-blur-md rounded-full text-[10px] font-black uppercase tracking-widest text-white shadow-xl">
                      {story.cat}
                    </div>
                  </div>
                  <div className="p-10 flex flex-col flex-grow">
                    <h4 className="text-2xl md:text-3xl font-black mb-6 text-[#002147] dark:text-white leading-tight group-hover:text-emerald-500 transition-colors tracking-tight">
                      {story.title}
                    </h4>
                    ...
                    <div className="mt-auto pt-8 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                       <button 
                        ...
                        className="flex items-center text-xs font-black uppercase tracking-[0.2em] text-[#002147] dark:text-white group-hover:text-emerald-600 transition-colors"
                       >
      ...
      {/* Story Full Access intelligence Modal */}
      {selectedStory && (
        <div className="fixed inset-0 z-[400] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-4xl max-h-[90vh] bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl overflow-y-auto animate-in zoom-in-95 duration-300 border border-white/10">
            <div className="sticky top-0 z-10 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-10 py-8 border-b border-gray-100 dark:border-white/5 flex justify-between items-center">
              <div>
                <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600 mb-1 block">{selectedStory.cat} Intelligence</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-5 space-y-8">
                  ...
                  <div className="bg-[#002147] p-8 rounded-[2.5rem] text-white">
                    <h5 className="text-[10px] font-black uppercase tracking-widest text-emerald-400 mb-4">Mission Metadata</h5>
